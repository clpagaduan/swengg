						...
						<div class="card">
							<div class="card-body p-5">
								...
								<div class="form-group">
									...
									<input type="number" class="form-control" name="dlsuid" placeholder="e.g. 11412345" required> 
								</div>
								<div class="form-group">
									<label>Email Address</label>
									<input type="email" class="form-control" name="email" placeholder="e.g. juan_delacruz@dlsu.edu.ph" required> 
								</div>
								<div class="form-group">
