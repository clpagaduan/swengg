      ...
      <div class="row">
        ...
        <div class="justify-content-center col-md-4">
          <div class="card">
            ...
            <div class="card-body">
              <h3 class="card-title" contenteditable="true">Delo, 21</h3>
              <p class="card-text lead">Netflix and chill?
                <br>Interests: Pizza, Blackpink, Star Wars, Victor Magtanggol
                <br>
                <br>ID: 114 &nbsp; &nbsp; College: CCS &nbsp; &nbsp;GPA: 3.25</p>
